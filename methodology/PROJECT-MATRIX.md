...
> **Canonical methodological source / Fuente metodológica canónica:** `gslhub/research`  
> Migrated from `gslhub/website/docs/PROJECT-MATRIX.md` on 18 August 2026. Future conceptual-methodology changes belong here.
...
See the current bilingual presentation runbook in [`gslhub/website/docs/DOCTORAL-DEMO.md`](https://github.com/gslhub/website/blob/main/docs/DOCTORAL-DEMO.md).
...
**Last updated / Última actualización:** 18 August / agosto 2026

---

Except where otherwise noted, this document is licensed under **CC BY 4.0**. See the repository [`LICENSE`](../LICENSE) and [`LICENSING.md`](../LICENSING.md).
