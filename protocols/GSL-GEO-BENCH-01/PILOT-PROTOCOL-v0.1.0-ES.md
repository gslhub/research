...
> **Fuente metodológica canónica:** `gslhub/research`  
> Migrado desde `gslhub/website/docs/PROTOCOLO_PRIMER_PILOTO_ES.md` el 18 de agosto de 2026. Las futuras revisiones del protocolo deben versionarse aquí.
...
2. seguir [`codebooks/OBSERVATIONS-CITATIONS-v0.1.0-ES.md`](../../codebooks/OBSERVATIONS-CITATIONS-v0.1.0-ES.md);
...
El procedimiento operativo completo permanece documentado en [`gslhub/website/docs/PROCEDIMIENTO_ALMACENAMIENTO_BACKUP_RECUPERACION_ES.md`](https://github.com/gslhub/website/blob/main/docs/PROCEDIMIENTO_ALMACENAMIENTO_BACKUP_RECUPERACION_ES.md).
...
Excepto cuando se indique lo contrario, este documento está licenciado bajo **CC BY 4.0**. Consulte [`LICENSE`](../../LICENSE) y [`LICENSING.md`](../../LICENSING.md).
